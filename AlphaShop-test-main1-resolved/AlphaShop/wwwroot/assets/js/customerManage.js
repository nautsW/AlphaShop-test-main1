document.addEventListener('DOMContentLoaded', function () {
    ...
    const showBtn_restrict = document.getElementById('js_restrict')
    ...
    showBtn_restrict.addEventListener('click', function () {
        modal_restrict.style.display = 'flex';
    });
    ...
    const closeModalBtn5 = document.getElementById('btn-Cancel1');
